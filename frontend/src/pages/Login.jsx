    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-apple-bg/50 px-4">
      <div className="max-w-md w-full bg-apple-card rounded-apple-card shadow-apple-card border border-apple-divider p-10 transform transition-all duration-300">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-apple-text-primary tracking-tight">Welcome Back</h2>
          <p className="mt-2 text-sm text-apple-text-secondary font-medium">Access your AI Digital Twin</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-apple-text-secondary text-sm font-medium">
            Don't have an account? <Link to="/register" className="text-apple-blue hover:text-apple-blue-active font-bold transition-colors">SignUp</Link>
          </p>
        </div>
      </div>
    </div>
